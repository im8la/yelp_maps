...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 2
    return {'name': name, 'loc': location, 'cat': categories, 'price': price, 'rev': reviews}
    # END Question 2
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 2
    return [review_rating(rev) for rev in restaurant.get('rev')]
    # END Question 2
